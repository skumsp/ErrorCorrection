...
//                return ((double) d)/(end-st+1);
		...
		DNASequence target = new DNASequence(this.nucl,AmbiguityDNACompoundSet.getDNACompoundSet());
		DNASequence query = new DNASequence(r.nucl,AmbiguityDNACompoundSet.getDNACompoundSet());
